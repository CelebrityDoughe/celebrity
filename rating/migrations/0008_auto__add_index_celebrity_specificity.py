...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Celebrity', fields ['specificity']
        db.create_index(u'rating_celebrity', ['specificity'])


    def backwards(self, orm):
        # Removing index on 'Celebrity', fields ['specificity']
        db.delete_index(u'rating_celebrity', ['specificity'])
