...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Rating', fields ['user']
        db.delete_unique(u'rating_rating', ['user_id'])


        # Changing field 'Rating.user'
        db.alter_column(u'rating_rating', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Rating.user'
        db.alter_column(u'rating_rating', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'Rating', fields ['user']
        db.create_unique(u'rating_rating', ['user_id'])
