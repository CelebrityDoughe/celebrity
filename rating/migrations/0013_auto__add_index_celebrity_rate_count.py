...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Celebrity', fields ['rate_count']
        db.create_index(u'rating_celebrity', ['rate_count'])


    def backwards(self, orm):
        # Removing index on 'Celebrity', fields ['rate_count']
        db.delete_index(u'rating_celebrity', ['rate_count'])
    ...
    models = {
        u'rating.celebrity': {
            ...
            'rate_count': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True'}),
