...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Celebrity.average_rate'
        db.add_column(u'rating_celebrity', 'average_rate',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Celebrity.rate_count'
        db.add_column(u'rating_celebrity', 'rate_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Celebrity.average_rate'
        db.delete_column(u'rating_celebrity', 'average_rate')

        # Deleting field 'Celebrity.rate_count'
        db.delete_column(u'rating_celebrity', 'rate_count')
