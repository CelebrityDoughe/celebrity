...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Celebrity.specificity'
        db.alter_column(u'rating_celebrity', 'specificity', self.gf('django.db.models.fields.CharField')(max_length=16))

    def backwards(self, orm):

        # Changing field 'Celebrity.specificity'
        db.alter_column(u'rating_celebrity', 'specificity', self.gf('django.db.models.fields.CharField')(max_length=1))
    ...
    models = {
        ...
        u'rating.celebrity': {
            ...
            'specificity': ('django.db.models.fields.CharField', [], {'max_length': '16'})
        },
        u'rating.rating': {
