...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Rating'
        db.create_table(u'rating_rating', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('celebrity', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rates', to=orm['rating.Celebrity'])),
        ...
        db.send_create_signal(u'rating', ['Rating'])


    def backwards(self, orm):
        # Deleting model 'Rating'
        db.delete_table(u'rating_rating')
