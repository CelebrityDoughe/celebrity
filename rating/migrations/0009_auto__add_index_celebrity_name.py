...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Celebrity', fields ['name']
        db.create_index(u'rating_celebrity', ['name'])


    def backwards(self, orm):
        # Removing index on 'Celebrity', fields ['name']
        db.delete_index(u'rating_celebrity', ['name'])
