...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Article.news_website'
        db.alter_column(u'news_article', 'news_website_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['news.NewsWebsite'], null=True))

    def backwards(self, orm):

        # Changing field 'Article.news_website'
        db.alter_column(u'news_article', 'news_website_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['news.NewsWebsite']))
    ...
    models = {
        ...
        u'news.article': {
            ...
            'article_image': ('django.db.models.fields.files.ImageField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
            ...
            'news_website': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'to': u"orm['news.NewsWebsite']", 'null': 'True', 'blank': 'True'}),
            'text': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'url': ('django.db.models.fields.URLField', [], {'db_index': 'True', 'max_length': '200', 'blank': 'True'})
        },
        u'news.newswebsite': {
