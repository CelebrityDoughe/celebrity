...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Article.source_url'
        db.delete_column(u'news_article', 'source_url')

        # Adding field 'Article.url'
        db.add_column(u'news_article', 'url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Article.source_url'
        db.add_column(u'news_article', 'source_url',
                      self.gf('django.db.models.fields.URLField')(default=None, max_length=200),
                      keep_default=False)

        # Deleting field 'Article.url'
        db.delete_column(u'news_article', 'url')
