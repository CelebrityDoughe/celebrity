...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.text'
        db.add_column(u'news_article', 'text',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Article.article_image'
        db.add_column(u'news_article', 'article_image',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.text'
        db.delete_column(u'news_article', 'text')

        # Deleting field 'Article.article_image'
        db.delete_column(u'news_article', 'article_image')
    ...
    models = {
        ...
        u'news.article': {
            ...
            'article_image': ('django.db.models.fields.files.ImageField', [], {'default': "''", 'max_length': '100'}),
